...
export function Spoke({ x, y, r1, r2, angle }: SpokeState): JSX.Element {
 ...
 return <line x1={vz(x1)} x2={vz(x2)} y1={vz(y1)} y2={vz(y2)} stroke="black" strokeWidth={vz(0.5)} stroke-linecap="round">
    </line>
}
